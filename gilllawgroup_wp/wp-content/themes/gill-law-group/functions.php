...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        // wp_register_script('gill-law-group-js', get_template_directory_uri() . '/assets/dist/js/production.js', array('jquery'), '1.0.0', true); // Custom scripts
        // wp_enqueue_script('gill-law-group-js'); // Enqueue it!
    }
}
...
{
    wp_register_style('gill-law-group-styles', get_template_directory_uri() . '/assets/src/scss/main.css', array(), '1.0', 'all');
    wp_enqueue_style('gill-law-group-styles'); // Enqueue it!
}
